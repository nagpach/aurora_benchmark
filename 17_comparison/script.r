...
results <- data.frame(
  ...
  row.names = c(
    "amazon_rds_aurora_1.6.5",
    "amazon_rds_aurora_1.7"
  ),
  file = c(
...
plot(0, 0,
  pch=".", col="white", xaxt="n", ylim=c(0,4000), xlim=c(0,length(steps)),
